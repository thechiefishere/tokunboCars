    ...
    <section className="section details">
      ...
      <article className="details-article">
        ...
        <p className="details-article-desc">
          ...
          impedit distinctio officiis repudiandae aliquam illo laudantium
          ...
          mollitia placeat nulla beatae error numquam delectus ea laudantium rem
          voluptas dolorem ratione laboriosam saepe ipsam hic facere soluta
          doloremque at consequuntur, voluptate illum reprehenderit. Officia
          repudiandae maxime eius.
        </p>
      </article>
